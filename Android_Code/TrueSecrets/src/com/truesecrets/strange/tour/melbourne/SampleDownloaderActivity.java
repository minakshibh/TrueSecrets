...
public class SampleDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    static IStub mDownloaderClientStub;
...
//                    70858919L // the length of the file in bytes
    ...
    boolean expansionFilesDelivered() {
        for (XAPKFile xf : xAPKS) {
            ...
            Log.e("file name",":: "+fileName+",,,"+Helpers.getSaveFilePath(getApplicationContext()));
            
         /*   File file = new File(Helpers.getSaveFilePath(getApplicationContext())+"/"+fileName);
            if(file.exists()){
            	Log.e("file exists","file exists");
            }else{
            	Log.e("file does not exists","file does not exists");
            	try {
					file.createNewFile();
				} catch (IOException e) {
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    mPauseButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
//                            finish();
                        	Intent i = new Intent(SampleDownloaderActivity.this, MainActivity.class);
                        	startActivity(i);
                        	finish();
                        }
                    });
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // Enable automated usage reporting.
        ...
        if (!expansionFilesDelivered()) {
        	...
        	Log.e("expansion files not available","ready to download");
            try {
        	...
        	Log.e("expansion files available","ready to unzip");
            validateXAPKZipFiles();
        }
        
        Log.e("expansion files","starting main activity");
        Intent i = new Intent(SampleDownloaderActivity.this, MainActivity.class);
        startActivity(i);
        finish();
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        Long percent = progress.mOverallProgress
        ...
        if(percent>100){
        	percent = (long) 100;
//        	mPB.setProgress((int) (progress.mOverallTotal >> 8));
        	mProgressFraction.setText(Helpers.getDownloadProgressString
                    (progress.mOverallTotal,
                            progress.mOverallTotal));
        	 mTimeRemaining.setText("00:00");
        }
        
        mProgressPercent.setText( Long.toString(percent) + "%");
