...
@interface Secret5ViewController ()

@end

@implementation Secret5ViewController
...
- (void)viewDidLoad
{
    ...
    if (UI_USER_INTERFACE_IDIOM()== UIUserInterfaceIdiomPad)
    {
        ...
        lblSecretNo.text = @"Secret #5";
        lblSecretNo.font = [UIFont fontWithName:@"IM FELL DW Pica SC" size:28];
        [scrollView addSubview:lblSecretNo];
        
        UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(180, 100, 400, 25)];
        lable.text = @"Witness of secret bank deals break silence";
        ...
        lable = [[UILabel alloc] initWithFrame: CGRectMake(25, 115, 700, 45)];
        [lable setTextColor: [UIColor whiteColor]] ;
        [lable setBackgroundColor:[UIColor clearColor]];
        lable.numberOfLines = 3;
        lable.textAlignment=NSTextAlignmentCenter;
        lable.text =@" Who are the two financial district witnesses that tell everything after being  slient for 120 years?";
        ...
        view_mapview1.frame=CGRectMake(12, 180, 740, 220);
        ...
        mapDetails.text = @"The Global Financial Crisis of 2007-2008 bears a striking similarity to the 1893 financial collapse in victoria...When another glass and steel building went up across the street, these guys had to speak up.";
        ...
        //mapText.tag=i;
        mapText1.text = @"Find your way to 382 Collins St. (just before Queen St.) remain very still and they will reveal themselves.";
    ...
    lable.numberOfLines = 3;
    lable.textAlignment=NSTextAlignmentCenter;
    lable.text =@" Who are the two financial district witnesses that tell\neverything after being  slient for 120 years?";
    ...
    mapDetails.text = @"The Global Financial Crisis of 2007-2008 bears a striking \nsimilarity to the 1893 financial collapse in victoria...\nWhen another glass and steel building went up across the \nstreet, these guys had to speak up.";
    mapDetails.numberOfLines = 15;
    [scrollView addSubview:mapDetails];
    ...
    mapText1.numberOfLines = 3;
    //mapText.tag=i;
    mapText1.text = @"Find your way to 382 Collins St. (just before Queen St.)\n remain very still and they will reveal themselves.";
    [scrollView addSubview:mapText1];
...
- (void)getbackgroundSoundbtn:(id)sender
{
    ...
    if (backgroundvalue==TRUE)
    {
        ...
        if (isBackgroundInit==TRUE)
        {
            ...
            backgroundMusicFile = @"Secret_5_Background";
...
- (void)playbutton:(id)sender
{
    ...
    [scrollView addSubview:playButton1];
    musicplayfile = @"gargoyles_master";
...
-(void)getBonusSoundBtn:(id)sender
{
    ...
    else
    {
        ...
        else
        {
            ...
            [getBonusBtn2 setImage:[UIImage imageNamed:@"pause.png"] forState:UIControlStateNormal];
            backgroundMusicFile = @"Secret_5_Bonus";
            NSURL *url=[NSURL fileURLWithPath:[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@",backgroundMusicFile] ofType:@"mp3"]];
...
-(void)showMe1:(id)sender
{
    ...
    if (!bool_showmap==TRUE)
    {
        ...
        showMeImage.image=[UIImage imageNamed:@"show5.jpg"];
        /*
         break;
         case 2:
...
- (void) cordinate
{
    ...
    region.center.latitude = -37.816734;
    region.center.longitude = 144.961899;
