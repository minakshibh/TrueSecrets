...
@interface Secret4ViewController ()

@end

@implementation Secret4ViewController
...
- (void)viewDidLoad
{
    ...
    if (UI_USER_INTERFACE_IDIOM()== UIUserInterfaceIdiomPad) {
        ...
        lblSecretNo.text = @"Secret #4";
        lblSecretNo.font = [UIFont fontWithName:@"IM FELL DW Pica SC" size:28];
        [scrollView addSubview:lblSecretNo];
        
        UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(220, 102,400, 25)];
        lable.text = @"Beatles assassination attempt from tower";
        ...
        lable = [[UILabel alloc] initWithFrame: CGRectMake(15, 115, 750, 45)];
        [lable setTextColor: [UIColor whiteColor]] ;
        [lable setBackgroundColor:[UIColor clearColor]];
        lable.numberOfLines = 2;
        lable.textAlignment=NSTextAlignmentCenter;
        lable.text =@"Why was a teen-aged boy,his girlfriend and a high-powered rlife in the tower at the same time the Beatles \nappeared across the street?";
        lable.font = [UIFont fontWithName:@"Helvetica" size:13];
        [scrollView addSubview:lable];
        
        UIButton *mapButton=[UIButton buttonWithType:UIButtonTypeCustom];
        mapButton.frame=CGRectMake(120, 155, 632, 25);
        ...
        label_maplabelShow1= [[UILabel alloc]initWithFrame:CGRectMake(120, 180, 632, 25)];
        ...
        view_mapview1.frame=CGRectMake(10, 190, 740, 220);
        ...
        showMeWhere.frame = CGRectMake(120, 420, 632, 25);
        ...
        secondView1.frame=CGRectMake(10, 210, 740, 220);
        ...
        mapView.frame=CGRectMake(25, 230, 710 , 165);
        ...
        mapDetails.text = @"Girls seemed possessed as they screamed and swooned, pledging their love to the Beatles when they came to Melbourne in 1964. The tower of the Manchester Unity Building has a perfect line of sight to the Town hall balcony.";
        mapDetails.numberOfLines = 2;
        [scrollView addSubview:mapDetails];
        
        
        mapText1 = [[UILabel alloc] initWithFrame: CGRectMake(45, 185, 740, 45)];
        ...
        mapText1.numberOfLines = 2;
        //mapText.tag=i;
        mapText1.text = @"Find a good vantage point where you can see the Manchester Unity Building and the balcony above the entrance of the Melbourne \nTown Hall and it will make sense.";
    ...
    lable.textAlignment=NSTextAlignmentCenter;
    lable.text =@"Why was a teen-aged boy,his girlfriend and a high-powered \nrlife in the tower at the same time the Beatles appeared \nacross the street?";
    ...
    mapDetails.text = @"Girls seemed possessed as they screamed and swooned,\npledging their love to the Beatles when they came to \nMelbourne in 1964. The tower of the Manchester Unity \nBuilding has a perfect line of sight to the Town hall balcony.";
    ...
    //mapText.tag=i;
    mapText1.text = @"Find a good vantage point where you can see the \nManchester Unity Building and the balcony above the \nentrance of the Melbourne Town Hall and it will make sense.";
    [scrollView addSubview:mapText1];
...
- (void)getbackgroundSoundbtn:(id)sender
{
    ...
    if (backgroundvalue==TRUE)
    {
        ...
        if (isBackgroundInit==TRUE)
        {
            ...
            backgroundMusicFile = @"Secret_4_Background";
...
-(void)getBonusSoundBtn:(id)sender
{
    ...
    else
    {
        ...
        else
        {
            ...
            [getBonusBtn2 setImage:[UIImage imageNamed:@"pause.png"] forState:UIControlStateNormal];
            backgroundMusicFile = @"secret4_bonus_1";
            NSURL *url=[NSURL fileURLWithPath:[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@",backgroundMusicFile] ofType:@"mp3"]];
...
-(void)showMe1:(id)sender
{
    ...
    if (!bool_showmap==TRUE)
    {
        ...
        if (UI_USER_INTERFACE_IDIOM()==UIUserInterfaceIdiomPad) {
            showMeImage.frame=CGRectMake(25, 230, 710, 165);
        }
        else
        {
...
- (void) cordinate
{
    ...
    region.center.latitude =-37.814953;
    region.center.longitude = 144.966431;
