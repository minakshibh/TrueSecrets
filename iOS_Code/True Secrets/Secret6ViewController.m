...
@interface Secret6ViewController ()
@end

@implementation Secret6ViewController
...
- (void)viewDidLoad
{
    ...
    if (UI_USER_INTERFACE_IDIOM()== UIUserInterfaceIdiomPad) {
        ...
        lblSecretNo.text = @"Secret #6";
        lblSecretNo.font = [UIFont fontWithName:@"IM FELL DW Pica SC" size:28];
        [scrollView addSubview:lblSecretNo];
        
        UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(180, 100, 500, 25)];
        lable.text = @"Landlord brings down major telco at midnight";
        ...
        lable = [[UILabel alloc] initWithFrame: CGRectMake(45, 115, 700, 45)];
        [lable setTextColor: [UIColor whiteColor]] ;
        [lable setBackgroundColor:[UIColor clearColor]];
        lable.numberOfLines = 3;
        lable.textAlignment=NSTextAlignmentCenter;
        lable.text =@"What happened at midnight in the One.tel call center thatfinally brought the Company to an end?";
        ...
        mapDetails.text = @"The Rialto Tower was the perfect home for the corporate telco gaint One.tel. Reports of financial collapse  were denied for months, but on the night of 25th of May, the night-shift suddenly stopped answering calls.";
        ...
        //mapText.tag=i;
        mapText1.text = @"Find your way to the 520 Collins St. Look up at the Rialto building. It's all going down on the 36th floor.";
    ...
    UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(5, 100, 315, 25)];
    lable.text = @"Landlord brings down major telco at midnight";
    ...
    lable.numberOfLines = 3;
    lable.textAlignment=NSTextAlignmentCenter;
    lable.text =@"What happened at midnight in the One.tel call center that\nfinally brought the Company to an end?";
    ...
    mapDetails.text = @"The Rialto Tower was the perfect home for the corporate \ntelco gaint One.tel. Reports of financial collapse  were\ndenied for months, but on the night of 25th of May, the \nnight-shift suddenly stopped answering calls.";
    mapDetails.numberOfLines = 15;
    [scrollView addSubview:mapDetails];
    ...
    //mapText.tag=i;
    mapText1.text = @"Find your way to the 520 Collins St. Look up at the \nRialto building. It's all going down on the 36th floor.";
    [scrollView addSubview:mapText1];
...
- (void)getbackgroundSoundbtn:(id)sender
{
    ...
    if (backgroundvalue==TRUE)
    {
        ...
        if (isBackgroundInit==TRUE)
        {
            ...
            backgroundMusicFile = @"Secret_6_Background";
...
-(void)getBonusSoundBtn:(id)sender
{
    ...
    else
    {
        ...
        else
        {
            ...
            [getBonusBtn2 setImage:[UIImage imageNamed:@"pause.png"] forState:UIControlStateNormal];
            backgroundMusicFile = @"Secret_6_Bonus";
            NSURL *url=[NSURL fileURLWithPath:[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@",backgroundMusicFile] ofType:@"mp3"]];
...
- (void) cordinate
{
    ...
    region.center.latitude = -37.817966;
    region.center.longitude = 144.957626;
