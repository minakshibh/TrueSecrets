//
//  Secret2ViewController.m
//  True Secrets
//
//  Created by Krishna_Mac on 9/10/13.
...
@interface Secret2ViewController ()

@end

@implementation Secret2ViewController
...
- (void)viewDidLoad
{
   ...
   // [self fetchAvailableProducts];
    ...
    if (UI_USER_INTERFACE_IDIOM()== UIUserInterfaceIdiomPad) {
        ...
        lblSecretNo.text = @"Secret #2";
        lblSecretNo.font = [UIFont fontWithName:@"IM FELL DW Pica SC" size:28];
        [scrollView addSubview:lblSecretNo];
        
        UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(255, 100, 300, 25)];
        lable.text = @"Victim's body inside dim sims";
        ...
        lable = [[UILabel alloc] initWithFrame: CGRectMake(145, 115, 500, 45)];
        [lable setTextColor: [UIColor whiteColor]] ;
        [lable setBackgroundColor:[UIColor clearColor]];
        lable.numberOfLines = 1;
        lable.textAlignment=NSTextAlignmentCenter;
        lable.text =@"Did enterpreneurial gangsters create Melbourne's famous snack the Dim Sim?";
        ...
        mapDetails.numberOfLines = 1;
        mapDetails.text = @"In the 1920s some gangsters handled the money and some gangsters handled the bodies, sometimes they worked together.";
        ...
        //mapText.tag=i;
        mapText1.text = @"Find your way to the corner of Celstial Ave. and Little Bourke. The action takes place just outside those barred windows.";
    ...
    UILabel *lable = [[UILabel alloc] initWithFrame:CGRectMake(70, 100, 300, 25)];
    lable.text = @"Victim's body inside dim sims";
    ...
    lable.textAlignment=NSTextAlignmentCenter;
    lable.text =@"Did enterpreneurial gangsters create Melbourne's \nfamous snack the Dim Sim?";
    ...
    mapView.delegate = self;
        ...
        NSLog(@"Curent Latitude Secret 2: %f", myLocation.coordinate.latitude);
        NSLog(@"Curent Longitude Secret 2: %f",myLocation.coordinate.longitude);
    ...
    mapDetails.text = @"In the 1920s some gangsters handled the money and some gangsters handled the bodies, sometimes they worked\ntogether.";
    [scrollView addSubview:mapDetails];
    ...
    //mapText.tag=i;
    mapText1.text = @"Find your way to the corner of Celstial Ave. and Little Bourke. \nThe action takes place just outside those barred windows.";
    [scrollView addSubview:mapText1];
...
- (void)getbackgroundSoundbtn:(id)sender
{
        ...
        
    {
        ...
        if (isBackgroundInit==TRUE)
        {
            ...
            backgroundMusicFile = @"Secret_2_Background";
...
-(void)getBonusSoundBtn:(id)sender
{
    ...
    else
    {
        ...
        else
        {
            ...
            [getBonusBtn2 setImage:[UIImage imageNamed:@"pause.png"] forState:UIControlStateNormal];
            backgroundMusicFile = @"Secret_2_Bonus";
            NSURL *url=[NSURL fileURLWithPath:[[NSBundle mainBundle]pathForResource:[NSString stringWithFormat:@"%@",backgroundMusicFile] ofType:@"mp3"]];
...
- (void) cordinate
{
    ...
    region.center.latitude = -37.812157;
    region.center.longitude = 144.966400;
